...
import { BarChart2, Home as HomeIcon, Settings as SettingsIcon, BookOpen, Activity, ShoppingBag, User, Sun, Moon } from 'lucide-react';
            ...
            <div className="w-64 h-full flex flex-col bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800">
              ...
              <div className="p-4 border-t border-gray-200 dark:border-gray-800 space-y-2">
                ...
                <button
                  ...
                  className="w-full flex items-center space-x-2 px-4 py-2 text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors duration-200"
                >
                  {darkMode ? (
                    <>
