...
import { Settings as SettingsIcon, Bell, Shield, User, Moon, Activity } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6">
        ...
        <div className="space-y-4">
          ...
          <Link 
            to="/connect-google-fit"
            className="inline-block w-full"
          >
            <Button className="w-full">
              {isGoogleFitConnected ? 'Manage Google Fit Connection' : 'Connect Google Fit'}
            </Button>
          </Link>
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Connect your Google Fit account to get personalized Ayurvedic insights based on your activity, sleep, and heart rate data.
          </p>
        </div>
      </div>
