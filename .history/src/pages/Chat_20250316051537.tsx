  ...
  return (
    <div className="h-screen flex bg-gradient-to-b from-emerald-50 to-white dark:from-gray-900 dark:to-gray-800">
      ...
      <div 
        ...
        } transition-all duration-300 ease-in-out border-r border-emerald-100 dark:border-gray-800 bg-gradient-to-b from-emerald-50/80 to-white/80 dark:from-gray-900/80 dark:to-gray-800/80 backdrop-blur-sm overflow-hidden`}
      >
        <div className="w-80">
          {/* Knowledge Panel Header */}
          <div className="px-6 py-4 bg-emerald-600/10 dark:bg-emerald-900/20 border-b border-emerald-100 dark:border-emerald-900/30">
            <h2 className="text-lg font-semibold text-emerald-800 dark:text-emerald-200 flex items-center gap-2">
              <BookOpen className="h-5 w-5" />
              Ayurvedic Knowledge
            </h2>
            <p className="text-sm text-emerald-600 dark:text-emerald-300/80">
              Explore traditional wisdom & guidance
            </p>
          </div>

          <div className="p-6 space-y-6">
            {/* Quick Consultations */}
            <div className="bg-white/70 dark:bg-gray-800/50 rounded-xl p-4 shadow-sm">
              ...
              <div className="space-y-2">
                {quickPrompts.map((prompt, index) => (
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-3 py-2 text-left text-gray-700 dark:text-gray-300 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 rounded-lg transition-colors text-sm"
                  >
                    {prompt.icon}
                ...
                {Object.entries(doshaInfo).map(([dosha, info]) => (
                  ...
                  >
                    ...
                    {activeDoshaInfo === dosha && (
                      <div className="mt-2 p-3 bg-emerald-50/70 dark:bg-emerald-900/20 rounded-lg">
