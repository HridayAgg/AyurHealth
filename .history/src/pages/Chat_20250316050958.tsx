...
import { Send, Bot, Loader2, AlertCircle, Trash2, Info, Moon, Sun, Wind, Droplets, Flame, FlowerLotus, Leaf, BookOpen } from 'lucide-react';
...
export const Chat: React.FC = () => {
  ...
  const quickPrompts: QuickPrompt[] = [
    {
      icon: <FlowerLotus className="h-4 w-4" />,
  ...
  return (
    <div className="h-screen flex bg-gradient-to-b from-emerald-50 to-white dark:from-gray-900 dark:to-gray-800">
      {/* Sidebar */}
      <div className="w-80 border-r border-emerald-100 dark:border-gray-800 bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm overflow-y-auto">
        <div className="p-6">
          <div className="mb-8">
          ...
          <div className="text-xs text-gray-500 dark:text-gray-400">
            <p className="mb-2">Tip: Share your dosha type, daily routine, and health concerns for more personalized guidance.</p>
          </div>
        </div>
      </div>
