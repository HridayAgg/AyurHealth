...
const openai = new OpenAIApi(
  new Configuration({
    apiKey: import.meta.env.VITE_OPENAI_API_KEY, // Store this in `.env` for security
  })
);
  ...
  const handleSend = async () => {
    ...
    try {
      const assistantMessage: Message = {
        ...
        content: await getAyurvedicResponse(input),
        role: 'assistant',
        timestamp: new Date(),
      };
...
async function getAyurvedicResponse(input: string): Promise<string> {
  try {
